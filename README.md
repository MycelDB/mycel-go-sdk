...
The committed stubs on release branches are generated from the matching `mycel-api` release tag. The current `develop` branch is aligned with `mycel-api` `v0.9.0`.
