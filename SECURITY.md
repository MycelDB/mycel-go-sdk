...
- The affected SDK version, commit, or release tag.
- The affected package, function, helper, generated service client, or configuration path.
...
Security reports may apply to this Go SDK when behavior could expose data, weaken authentication, mishandle credentials, bypass TLS expectations, retry unsafe operations, leak sensitive metadata, or misrepresent API authorization semantics.
